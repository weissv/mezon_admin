...
export default function LmsLayout() {
 ...
 <Link
 to="/auth/login"
 className="inline-flex items-center justify-center rounded-[8px] bg-[#007AFF] px-5 py-2.5 text-[13px] font-medium text-white shadow-sm macos-transition hover:opacity-90"
 >
 Войти
 </Link>
 </div>
