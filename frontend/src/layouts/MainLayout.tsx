...
export default function MainLayout() {
 ...
 <Link
 to="/auth/login"
 className="inline-flex items-center justify-center rounded-[8px] bg-[#007AFF] px-5 py-2.5 text-[13px] font-medium text-white shadow-[0_0.5px_1px_rgba(0,0,0,0.12)] macos-transition hover:bg-[#0071EE]"
 >
 Перейти к входу
 </Link>
 </div>
