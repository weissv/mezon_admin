        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2 px-3 rounded-lg border macos-text-caption transition-all ${
      ...
      <div className="border-t border-[rgba(0,0,0,0.08)] pt-4">
        ...
        <div className="space-y-3">
          {fields.map((field, index) => {
            ...
            return (
              <div key={field.id} className={`rounded-lg border p-3 transition-all ${isLinked ? 'border-green-200 bg-[rgba(52,199,89,0.06)]/30' : 'border-[rgba(0,0,0,0.08)] bg-white'}`}>
                    ...
                    <Controller
                      ...
                      render={({ field: unitField }) => (
                        <select
                          ...
                          className="w-full px-2 py-2 border border-[rgba(0,0,0,0.08)] rounded-md text-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
