...
5. **Финансы и Биллинг (`/finance`):** Движение денежных средств (ПКО/РКО), безналичные расчёты, ведение статей расходов/доходов, учёт договоров обучения (Student Contracts), автоматическая генерация ежемесячных инвойсов, отслеживание задолженностей учеников (индикаторы должников `balance` & `hasDebt`).
