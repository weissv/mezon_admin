...
const sync_routes_1 = __importDefault(require("./modules/onec/routes/sync.routes"));
const onec_data_routes_1 = __importDefault(require("./modules/onec/routes/onec-data.routes"));
...
app.use("/api/integrations", sync_routes_1.default);
app.use("/api/onec-data", onec_data_routes_1.default);
